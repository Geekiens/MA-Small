...
public final class RatingEntityMapper {
    public static bookReviewer.entity.rating.Rating map(bookReviewer.application.useCase.command.createRatingUseCase.Rating ratingInput, Long bookId, Long userId){
