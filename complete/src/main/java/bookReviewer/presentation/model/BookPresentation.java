...
public class BookPresentation {
    ...
    public BookPresentation(String author, String title, String genre, String[] keywords, String[] languages, String publisher, int pages, String isbn, int publishingYear, String content) {
        this.author = author;
        this.title = title;
        this.genre = genre;
